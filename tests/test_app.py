...
def test_delete_contact(client, sample_contact):
    # Assuming the app has a delete route like /delete/<id>
...
# def test_add_invalid_contact(client):
#     data = {
#         'name': '',  # Missing name should be invalid
#         'phone': '1234567890',
#         'email': 'invalidemail',
#         'type': 'Personal'
#     }
#     response = client.post('/add', data=data, follow_redirects=True)
#     assert response.status_code == 400  # Assuming the app returns 400 for bad input
#     assert b'Invalid data' in response.data  # Assuming error message is displayed
